...
ALTER USER ${SRCDB_ARC_USER} default tablespace USERS;
...
GRANT SELECT ON all_constraints TO ${SRCDB_ARC_USER};
GRANT SELECT ON all_cons_columns TO ${SRCDB_ARC_USER};
GRANT SELECT ON all_indexes TO ${SRCDB_ARC_USER};
GRANT SELECT ON all_ind_expressions TO ${SRCDB_ARC_USER};
GRANT SELECT ON all_part_tables TO ${SRCDB_ARC_USER};
GRANT SELECT ON all_part_key_columns TO ${SRCDB_ARC_USER};
GRANT SELECT ON all_tables TO ${SRCDB_ARC_USER};
GRANT SELECT ON all_tab_columns TO ${SRCDB_ARC_USER};
GRANT SELECT ON all_views TO ${SRCDB_ARC_USER};
GRANT SELECT ON dba_constraints TO ${SRCDB_ARC_USER};
GRANT SELECT ON dba_cons_columns TO ${SRCDB_ARC_USER};
GRANT SELECT ON dba_indexes TO ${SRCDB_ARC_USER};
GRANT SELECT ON dba_ind_columns TO ${SRCDB_ARC_USER};
GRANT SELECT ON dba_lobs TO ${SRCDB_ARC_USER};
GRANT SELECT ON dba_objects TO ${SRCDB_ARC_USER};
GRANT SELECT ON dba_roles TO ${SRCDB_ARC_USER};
GRANT SELECT ON dba_tables TO ${SRCDB_ARC_USER};
GRANT SELECT ON dba_tab_cols TO ${SRCDB_ARC_USER};
GRANT SELECT ON gv_\$database TO ${SRCDB_ARC_USER};
GRANT SELECT ON gv_\$instance TO ${SRCDB_ARC_USER};
GRANT SELECT ON gv_\$transaction TO ${SRCDB_ARC_USER};
GRANT SELECT ON v_\$archived_log to ${SRCDB_ARC_USER};
GRANT SELECT ON v_\$database TO ${SRCDB_ARC_USER};
GRANT SELECT ON v_\$log TO ${SRCDB_ARC_USER};
GRANT SELECT ON v_\$logfile TO ${SRCDB_ARC_USER};
GRANT SELECT ON v_\$transportable_platform TO ${SRCDB_ARC_USER};
