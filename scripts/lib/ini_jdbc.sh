...
case "${SRCDB_GRP,,}" in
  ...
  snowflake)
    ...
    SRCDB_JDBC_URL="jdbc:snowflake://${SRCDB_HOST}:${SRCDB_PORT}/?schema=%22${SRCDB_SCHEMA}%22&warehouse=${SNOW_SRC_WAREHOUSE}&db=%22${SRCDB_USER_CHANGE}%22"   
    SRCDB_JDBC_URL_BENCHBASE="jdbc:snowflake://${SRCDB_HOST}:${SRCDB_PORT}/?schema=%22${SRCDB_SCHEMA}%22&amp;warehouse=${SNOW_SRC_WAREHOUSE}&amp;db=%22${SRCDB_USER_CHANGE}%22"   
    SRCDB_JDBC_NO_REWRITE=""
    SRCDB_JDBC_REWRITE=""
...
case "${DSTDB_GRP,,}" in
  ...
  snowflake)
    ...
    DSTDB_JDBC_URL="jdbc:snowflake://${DSTDB_HOST}:${DSTDB_PORT}/?db=%22${DSTDB_USER_CHANGE}%22&schema=%22${DSTDB_SCHEMA}%22&warehouse=${SNOW_DST_WAREHOUSE}"   
    DSTDB_JDBC_URL_BENCHBASE="jdbc:snowflake://${DSTDB_HOST}:${DSTDB_PORT}/?db=%22${DSTDB_USER_CHANGE}%22&amp;schema=%22${DSTDB_SCHEMA}%22&amp;warehouse=${SNOW_DST_WAREHOUSE}"   
    DSTDB_JDBC_NO_REWRITE=""
    DSTDB_JDBC_REWRITE=""
