...
ALTER TABLE  YCSBSPARSE10 ENABLE CHANGE_TRACKING;
ALTER TABLE  YCSBSPARSE100 ENABLE CHANGE_TRACKING;
ALTER TABLE  YCSBDENSE ENABLE CHANGE_TRACKING;
ALTER TABLE  YCSBDENSE10 ENABLE CHANGE_TRACKING;
ALTER TABLE  YCSBDENSE100 ENABLE CHANGE_TRACKING;
