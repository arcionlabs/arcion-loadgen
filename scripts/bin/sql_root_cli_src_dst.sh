...
# start the CLI
tmux send-keys -t :$TMUX_SCREEN.0  "banner src; . /tmp/ini_menu.sh; . /scripts/lib/jdbc_cli.sh; jdbc_root_cli_src" enter
tmux send-keys -t :$TMUX_SCREEN.1  "banner dst; . /tmp/ini_menu.sh; . /scripts/lib/jdbc_cli.sh; jdbc_root_cli_dst" enter
